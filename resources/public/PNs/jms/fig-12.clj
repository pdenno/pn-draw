{:places
 ...
 [{:name :wc1-start-job,
  ...
  {:name :blue-start-job,
   ...
   :type :immediate,
   :rate 1.0,
   :rep {:clk 600.371, :act :blue-start-job, :m :wc3-2, :mjpact :sm, :bf :b2, :n 2, :j 447, :line 716},
   :visible? true}
  {:name :blue-complete-job,
   :tid 14,
   :type :exponential,
   :rate 1.0,
   :rep {:clk 603.971, :act :blue-complete-job, :m :wc3-2, :mjpact :bj, :bf :b3, :n 0, :j 447, :line 742},
   :visible? true}
  {:name :wc4-start-job,
   :tid 15,
   :type :exponential,
  ...
  {:name :red-start-job,
   ...
   :type :immediate,
   :rate 1.0,
   :rep {:clk 600.371, :act :red-start-job, :m :wc3-1, :mjpact :sm, :bf :b2, :n 2, :j 447, :line 716},
   :visible? true}
  {:name :red-complete-job,
   :tid 14,
   :type :exponential,
   :rate 1.0,
   :rep {:clk 603.971, :act :red-complete-job, :m :wc3-1, :mjpact :bj, :bf :b3, :n 0, :j 447, :line 742},
   :visible? true}
  {:name :wc5-start-job,
   :tid 17,
   :type :exponential,
 ...
 [{:aid 18, :source :wc1-start-job, :target :place-2, :name :aa-18, :type :normal, :multiplicity 1, :bind {:jtype :blue}, :priority 1}
  ...
  {:aid 25, :source :place-5, :target :blue-start-job, :name :aa-25, :type :normal, :multiplicity 1, :bind {:jtype :blue} :draw-color :blue}
  {:aid 26, :source :blue-start-job, :target :place-6, :name :aa-26, :type :normal, :multiplicity 1, :bind {:jtype :blue}, :priority 1}
  {:aid 27, :source :place-6, :target :blue-complete-job, :name :aa-27, :type :normal, :multiplicity 1, :bind {:jtype :blue}}
  {:aid 28, :source :blue-complete-job, :target :place-7, :name :aa-28, :type :normal, :multiplicity 1, :bind {:jtype :blue}, :priority 2}
  ...
  {:aid 55, :source :blue-complete-job, :target :wait-3, :name :aa-55, :type :normal, :multiplicity 1, :bind {:jtype :blue}, :priority 1}
  {:aid 56, :source :wait-3, :target :blue-start-job, :name :aa-56, :type :normal, :multiplicity 1, :bind {:jtype :blue} }
  {:aid 58, :source :place-p-1, :target :red-complete-job, :name :arc-p-1, :type :normal, :multiplicity 1, :bind {:jtype :blue}}
  {:aid 59,
   :source :red-complete-job,
   :target :place-p-2,
   :name :arc-p-2,
   :type :normal,
   :multiplicity 1,
  ...
  {:aid 60,
   ...
   :bind {:jtype :blue},
   :priority 1}
  {:aid 61, :source :place-p-2, :target :red-start-job, :name :arc-p-4, :type :normal, :multiplicity 1, :bind {:jtype :blue}}
  {:aid 155, :source :place-5, :target :red-start-job, :name :aa-155, :type :normal, :multiplicity 1, :bind {:jtype :blue} :draw-color :red}
  {:aid 156, :source :red-complete-job, :target :place-7, :name :aa-156, :type :normal, :multiplicity 1, :bind {:jtype :blue}}
  ...
  {:aid 165, :source :place-7, :target :red-start-job, :name :aa-162, :type :inhibitor, :multiplicity 1}
  {:aid 166, :source :place-7, :target :blue-start-job, :name :aa-162, :type :inhibitor, :multiplicity 1}
  
  {:aid 167, :source :place-p-1, :target :blue-start-job, :name :aa-162, :type :inhibitor, :multiplicity 1}
  {:aid 168, :source :place-6, :target :red-start-job, :name :aa-162, :type :inhibitor, :multiplicity 1}],
 :geom
 {:red-start-job {:x 320, :y 359, :label-x-off 12, :label-y-off 18},
  :place-9 {:x 730, :y 469, :label-x-off -7, :label-y-off -22},
  :blue-complete-job {:x 552, :y 113, :label-x-off -25, :label-y-off -10},
  ...
  :red-complete-job {:x 411, :y 114, :label-x-off -80, :label-y-off -10},
  ...
  :blue-start-job {:x 481, :y 367, :label-x-off -17, :label-y-off 28},
